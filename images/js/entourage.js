...
/* ABC modifications: 
   1) added to whitelist: .txt, .tgz 
   2) just use pathname (don't remove beginning)
*/

(function() {
var entourage = new (function() {
	var version = "1.1.2abc";
	var whitelist = /\.pdf$|\.zip$|\.od*|\.doc*|\.xls*|\.ppt*|\.exe$|\.dmg$|\.mov$|\.avi$|\.mp3$|\.txt$|\.tgz$/i;
